		...
		for k in s:
			for l in t:
				for m in u:
					...
					command.append('srun -N1 -n1 /g/g92/bhowmik1/installCatalyst/TraceR/tracer/traceR --sync=1 --nkp=256 --extramem=1000000 --max-opt-lookahead=1000000 --avl-size=21 --lp-io-dir={}  -- {} {} > {} &\n'.format(outdir, netconf, config_name, outfile))
#for i in rmList:
#	print(i)
